...
/**
 * @file minitelnet-def.h
 * @brief Optional TELNET protocol and option definitions.
 *
 * This header provides constants used by common TELNET options.
 * These definitions are not required by the minitelnet protocol core.
 */

/**
 * @defgroup rfc855 RFC 855 Option Specification
 * @{
 */
 ...
 *
 * Option-specific semantics are not implemented by minitelnet.
 */
